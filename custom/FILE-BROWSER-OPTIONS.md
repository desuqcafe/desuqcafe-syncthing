...
Recorded 2026-09-26, before v2.1.6-desuq.10. **Nothing here is built.** The decision is
...
- thumbnails (`.blend` too, since v2.1.6-desuq.10), who has this file, version
...
## Recommendation (a proposal; nothing built)
