...
| **Old copies you can see** | Version history with thumbnails, so picking one out of fifty timestamps is looking rather than guessing and restoring. Upstream's endpoint answers with every version of every file in one document. | [§22](custom/DEPLOYMENT-3D-TEAM.md#22-two-people-edited-the-same-file-and-the-product-stopped-there) |
