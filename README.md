...
| **Blender add-on** (optional) | Opening a `.blend` says if somebody else is working on it or a newer version is still arriving, and otherwise marks it as yours while it is open. *File › desuqcafe Syncthing* for marks and notes. | [§33](custom/DEPLOYMENT-3D-TEAM.md#33-the-blender-add-on-optional) |
